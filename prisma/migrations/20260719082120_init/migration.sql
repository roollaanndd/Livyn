...
CREATE TABLE "ContributorProfile" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "ContributorProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Devotion" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "Devotion_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
    CONSTRAINT "Devotion_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "Sermon" (
    ...
    CONSTRAINT "Sermon_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "WatchProgress" (
    ...
    "updatedAt" DATETIME NOT NULL,
    CONSTRAINT "WatchProgress_sermonId_fkey" FOREIGN KEY ("sermonId") REFERENCES "Sermon" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "Bookmark" (
    ...
    CONSTRAINT "Bookmark_devotionId_fkey" FOREIGN KEY ("devotionId") REFERENCES "Devotion" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "PrayerLog" (
    ...
    "userId" TEXT NOT NULL,
    "reminderId" TEXT,
    "prayedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "note" TEXT,
    CONSTRAINT "PrayerLog_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT "PrayerLog_reminderId_fkey" FOREIGN KEY ("reminderId") REFERENCES "PrayerReminder" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE "Report" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT "Report_filedById_fkey" FOREIGN KEY ("filedById") REFERENCES "User" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
